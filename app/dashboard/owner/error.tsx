  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-6">
      <div className="w-full max-w-xl rounded-[28px] border border-rose-200 bg-white p-8 text-center shadow-sm">
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-rose-500">Owner Dashboard Error</p>
        <h2 className="mt-3 text-3xl font-semibold text-slate-900">This page could not load.</h2>
        <p className="mt-3 text-sm leading-6 text-slate-600">
          {error.message || "Something went wrong while loading the owner dashboard."}
        </p>
        <button
          onClick={reset}
